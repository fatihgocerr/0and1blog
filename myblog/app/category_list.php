	...
	<div class="main-wrapper">
		...
		<section class="blog-list px-3 py-5 p-md-5">
			<div class="container">
				...
				$id=(int)get("id");
				$db->sql="select * from tb_content where content_category_id order by content_id desc";
				$db->veri=array($id);
				$cat_content_list=$db->select();
				if ($cat_content_list==false) {
					?>
					...
					foreach ($cat_content_list as $key => $value) {
						?>
